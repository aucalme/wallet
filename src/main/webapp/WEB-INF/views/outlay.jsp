...
<head>
    ...
    <link href="${pageContext.request.contextPath}/resources/css/wallet.css" rel="stylesheet" type="text/css">
    ...
    <script src="${pageContext.request.contextPath}/resources/js/outlay.js"></script>
